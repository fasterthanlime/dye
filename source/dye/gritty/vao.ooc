...
VertexAttribInfo: class {
    ...
    use: func {
        "Having glVertexAttribPointer with name %s, and numComponents %d, type %d, normalized %d, stride %d, pointer %p" printfln(name, numComponents, type as Int, normalized, stride, pointer)
